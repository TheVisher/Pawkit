 ...
 *
 * Converts HTML content from TipTap editor to Markdown format.
...
function createTurndownService(): TurndownService {
  ...
  // Custom rule for images in TipTap
 ...
 */
export function downloadAsMarkdown(editor: Editor, filename: string): void {
  const html = editor.getHTML();
  downloadHtmlAsMarkdown(html, filename);
}
