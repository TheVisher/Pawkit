...
function TableFloatingToolbar({
  ...
  return (
    ...
    >
      ...
      >
        <Toolbar
          className="scrollbar-hide z-[100] flex w-auto max-w-[80vw] flex-row overflow-x-auto rounded-md border bg-popover p-1 shadow-md print:hidden"
          contentEditable={false}
        >
          <ToolbarGroup>
  ...
  return (
    <PlateElement
      ...
      attributes={{
        ...
        // Use React-compatible props via ref callback
