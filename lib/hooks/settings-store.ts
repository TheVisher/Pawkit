...
export type SettingsState = {
  ...
  cardPadding: number; // 0-4 scale (0=none, 1=xs, 2=sm, 3=md, 4=lg)
...
export const useSettingsStore = create<SettingsState>()(
  persist(
    (set) => ({
      ...
      showCardTitles: true, // Default to showing titles
      showCardUrls: true, // Default to showing URLs
      showCardTags: true, // Default to showing tags
      cardPadding: 3, // Default medium padding (p-4)
