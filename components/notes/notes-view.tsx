...
export function NotesView({ initialCards, initialLayout, collectionsTree, query }: NotesViewProps) {
    ...
    <>
      ...
      {showDeleteConfirm && (
        ...
        >
          ...
          >
            <h2 className="text-xl font-semibold text-gray-100 mb-4">Delete Notes?</h2>
            <p className="text-sm text-gray-400 mb-4">
              Move {selectedIds.length} selected note{selectedIds.length !== 1 ? 's' : ''} to Trash? You can restore them within 30 days.
            </p>
