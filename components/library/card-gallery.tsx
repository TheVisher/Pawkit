            ...
            <>
              ...
              {showLabels && card.url && !isFileCard && (
                <a
                  ...
                  onClick={(e) => e.stopPropagation()}
                  className="absolute bottom-2 left-8 right-8 px-3 py-1.5 rounded-full bg-black/40 backdrop-blur-md border border-white/10 text-xs text-white hover:bg-black/60 transition-colors flex items-center justify-center gap-1.5"
                >
              ...
              {showLabels && isFileCard && (
                <div
                  className="absolute bottom-2 left-8 right-8 px-3 py-1.5 rounded-full bg-black/40 backdrop-blur-md border border-white/10 text-xs text-white flex items-center justify-center gap-1.5"
                >
                  <span className="truncate max-w-full">
                    {card.title || "Untitled"}
                  </span>
