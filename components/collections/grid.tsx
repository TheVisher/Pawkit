...
const previewPositions = [
  "top-8 left-10 -rotate-6",
  "top-4 right-6 rotate-4",
  "bottom-8 left-16 rotate-2"
];
...
function PreviewTile({ card, positionClass }: PreviewTileProps) {
  ...
  return (
    <div
      className={`absolute flex w-28 -translate-x-1/2 -translate-y-1/2 flex-col overflow-hidden rounded-xl border border-gray-800 bg-gray-950/90 shadow-xl transition group-hover:scale-105 ${positionClass}`}
    >
      {card.image ? (
