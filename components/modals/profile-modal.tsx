...
import { Check, LogOut, Cloud, Calendar, HardDrive, Cloudy, Loader2, Settings2, Trash2 } from "lucide-react";
...
function ConnectorsTabContent() {
  ...
  // Check Dropbox connection on mount and after OAuth callback
  useEffect(() => {
      ...
      <div className="space-y-4">
        ...
        <div className="space-y-3">
          ...
          <ConnectorCard
            ...
            icon={<Cloudy className="h-6 w-6 text-blue-500" />}
