...
export function KeyboardShortcutsModal({ open, onClose, title = "Keyboard Shortcuts", footer = null, emptyState = null }: KeyboardShortcutsModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      >
        ...
        <div className="mb-6 flex items-center justify-between">
          <div>
            ...
            <p className="mt-1 text-sm text-muted-foreground">
              Master Pawkit in minutes—learn the essential shortcuts that keep you moving fast.
            </p>
          </div>
          <button
            onClick={onClose}
        ...
        {/* Shortcuts Grid */}
        <div className="rounded-2xl border border-white/10 bg-white/5/60 p-4 max-h-[70vh] space-y-8 overflow-y-auto pr-2">
