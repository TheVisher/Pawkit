/**
 * Daily Notes utilities for Pawkit Mobile
 * Adapted from web app's daily-notes.ts
 */
 ...
 */
export function getDailyNotes(cards: CardModel[]): DailyNote[] {
 ...
 */
export function findDailyNoteForDate(cards: CardModel[], date: Date): DailyNote | null {
...
/**
 * Format date for subtitle (e.g., "Sun, Nov 24")
 */
export function formatDateSubtitle(date: Date): string {
